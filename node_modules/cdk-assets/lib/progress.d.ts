 ...
 */
export declare function shellEventToEventType(event: ShellEventType): EventType;
/**
 ...
 */
export declare function shellEventPublisherFromEventEmitter(eventEmitter: EventEmitter): (event: ShellEventType, message: string) => void;
